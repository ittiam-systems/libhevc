 ...
 *  - ihevc_hbd_itrans_res_4x4_ttype1()
 *  - ihevc_hbd_itrans_res_4x4()
 *  - ihevc_hbd_itrans_res_dc()
 *  - ihevc_hbd_itrans_res_8x8()
 *  - ihevc_hbd_itrans_res_16x16()
 *  - ihevc_hbd_itrans_res_32x32()
 *
 * @remarks
 *  None
 *
...
void ihevc_hbd_itrans_res_4x4_ttype1(WORD16 *pi2_src,
                                     WORD16 *pi2_tmp,
                                     WORD16 *pi2_dst,
                                     WORD32 src_strd,
                                     WORD32 dst_strd,
...
void ihevc_hbd_itrans_res_4x4(WORD16 *pi2_src,
                              WORD16 *pi2_tmp,
                              WORD16 *pi2_dst,
                              WORD32 src_strd,
                              WORD32 dst_strd,
...
void ihevc_hbd_itrans_res_dc(WORD16 *pi2_dst,
                             WORD32 dst_strd,
...
void ihevc_hbd_itrans_res_8x8(WORD16 *pi2_src,
                              WORD16 *pi2_tmp,
                              WORD16 *pi2_dst,
                              WORD32 src_strd,
                              WORD32 dst_strd,
...
void ihevc_hbd_itrans_res_16x16(WORD16 *pi2_src,
                                WORD16 *pi2_tmp,
                                WORD16 *pi2_dst,
                                WORD32 src_strd,
                                WORD32 dst_strd,
...
void ihevc_hbd_itrans_res_32x32(WORD16 *pi2_src,
                                WORD16 *pi2_tmp,
                                WORD16 *pi2_dst,
                                WORD32 src_strd,
                                WORD32 dst_strd,
