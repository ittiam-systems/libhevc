...
*   - ihevc_hbd_weighted_pred_uni()
*   - ihevc_hbd_weighted_pred_bi()
*   - ihevc_hbd_weighted_pred_bi_default()
*
* @remarks
*  None
*
...
void ihevc_hbd_weighted_pred_bi(WORD16 *pi2_src1,
                                WORD16 *pi2_src2,
                                UWORD16 *pu2_dst,
                                WORD32 src_strd1,
                                WORD32 src_strd2,
...
void ihevc_hbd_weighted_pred_bi_default(WORD16 *pi2_src1,
                                        WORD16 *pi2_src2,
                                        UWORD16 *pu2_dst,
                                        WORD32 src_strd1,
                                        WORD32 src_strd2,
