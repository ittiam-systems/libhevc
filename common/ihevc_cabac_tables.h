...
typedef enum
{
    ...
    IHEVC_CAB_CHROMA_QP_OFF_FLAG    = IHEVC_CAB_EXPLICIT_RDPCM_DIR      + 2,
    IHEVC_CAB_CHROMA_QP_OFF_IDX     = IHEVC_CAB_CHROMA_QP_OFF_FLAG      + 1,
    IHEVC_CAB_CTXT_END              = IHEVC_CAB_CHROMA_QP_OFF_IDX       + 1,
