...
void ihevcd_update_function_ptr(codec_t *ps_codec)
{
    ...
    /* HBD functions */
    ps_codec->apf_hbd_intra_pred_luma[0] = NULL; // Unused
    ps_codec->apf_hbd_intra_pred_luma[1] = (pf_hbd_intra_pred_luma)ps_codec->s_func_selector.ihevc_hbd_intra_pred_luma_planar_fptr;
    ps_codec->apf_hbd_intra_pred_luma[2] = (pf_hbd_intra_pred_luma)ps_codec->s_func_selector.ihevc_hbd_intra_pred_luma_dc_fptr;
    ps_codec->apf_hbd_intra_pred_luma[3] = (pf_hbd_intra_pred_luma)ps_codec->s_func_selector.ihevc_hbd_intra_pred_luma_mode2_fptr;
    ps_codec->apf_hbd_intra_pred_luma[4] = (pf_hbd_intra_pred_luma)ps_codec->s_func_selector.ihevc_hbd_intra_pred_luma_mode_3_to_9_fptr;
    ps_codec->apf_hbd_intra_pred_luma[5] = (pf_hbd_intra_pred_luma)ps_codec->s_func_selector.ihevc_hbd_intra_pred_luma_horz_fptr;
    ps_codec->apf_hbd_intra_pred_luma[6] = (pf_hbd_intra_pred_luma)ps_codec->s_func_selector.ihevc_hbd_intra_pred_luma_mode_11_to_17_fptr;
    ps_codec->apf_hbd_intra_pred_luma[7] = (pf_hbd_intra_pred_luma)ps_codec->s_func_selector.ihevc_hbd_intra_pred_luma_mode_18_34_fptr;
    ps_codec->apf_hbd_intra_pred_luma[8] = (pf_hbd_intra_pred_luma)ps_codec->s_func_selector.ihevc_hbd_intra_pred_luma_mode_19_to_25_fptr;
    ps_codec->apf_hbd_intra_pred_luma[9] = (pf_hbd_intra_pred_luma)ps_codec->s_func_selector.ihevc_hbd_intra_pred_luma_ver_fptr;
    ps_codec->apf_hbd_intra_pred_luma[10] = (pf_hbd_intra_pred_luma)ps_codec->s_func_selector.ihevc_hbd_intra_pred_luma_mode_27_to_33_fptr;

    ps_codec->apf_hbd_intra_pred_chroma[0] = NULL; // Unused
    ps_codec->apf_hbd_intra_pred_chroma[1] = (pf_hbd_intra_pred_chroma)ps_codec->s_func_selector.ihevc_hbd_intra_pred_chroma_planar_fptr;
    ps_codec->apf_hbd_intra_pred_chroma[2] = (pf_hbd_intra_pred_chroma)ps_codec->s_func_selector.ihevc_hbd_intra_pred_chroma_dc_fptr;
    ps_codec->apf_hbd_intra_pred_chroma[3] = (pf_hbd_intra_pred_chroma)ps_codec->s_func_selector.ihevc_hbd_intra_pred_chroma_mode2_fptr;
    ps_codec->apf_hbd_intra_pred_chroma[4] = (pf_hbd_intra_pred_chroma)ps_codec->s_func_selector.ihevc_hbd_intra_pred_chroma_mode_3_to_9_fptr;
    ps_codec->apf_hbd_intra_pred_chroma[5] = (pf_hbd_intra_pred_chroma)ps_codec->s_func_selector.ihevc_hbd_intra_pred_chroma_horz_fptr;
    ps_codec->apf_hbd_intra_pred_chroma[6] = (pf_hbd_intra_pred_chroma)ps_codec->s_func_selector.ihevc_hbd_intra_pred_chroma_mode_11_to_17_fptr;
    ps_codec->apf_hbd_intra_pred_chroma[7] = (pf_hbd_intra_pred_chroma)ps_codec->s_func_selector.ihevc_hbd_intra_pred_chroma_mode_18_34_fptr;
    ps_codec->apf_hbd_intra_pred_chroma[8] = (pf_hbd_intra_pred_chroma)ps_codec->s_func_selector.ihevc_hbd_intra_pred_chroma_mode_19_to_25_fptr;
    ...
    ps_codec->apf_hbd_itrans_recon[3] = (pf_hbd_itrans_recon)ps_codec->s_func_selector.ihevc_hbd_itrans_recon_16x16_fptr;
    ps_codec->apf_hbd_itrans_recon[4] = (pf_hbd_itrans_recon)ps_codec->s_func_selector.ihevc_hbd_itrans_recon_32x32_fptr;
    ...
    ps_codec->apf_hbd_recon[0] = (pf_hbd_recon)ps_codec->s_func_selector.ihevc_hbd_recon_4x4_ttype1_fptr;
    ps_codec->apf_hbd_recon[1] = (pf_hbd_recon)ps_codec->s_func_selector.ihevc_hbd_recon_4x4_fptr;
    ps_codec->apf_hbd_recon[2] = (pf_hbd_recon)ps_codec->s_func_selector.ihevc_hbd_recon_8x8_fptr;
    ps_codec->apf_hbd_recon[3] = (pf_hbd_recon)ps_codec->s_func_selector.ihevc_hbd_recon_16x16_fptr;
    ps_codec->apf_hbd_recon[4] = (pf_hbd_recon)ps_codec->s_func_selector.ihevc_hbd_recon_32x32_fptr;
    ...
    ps_codec->apf_hbd_sao_luma[2] = (pf_hbd_sao_luma)ps_codec->s_func_selector.ihevc_hbd_sao_edge_offset_class2_fptr;
    ps_codec->apf_hbd_sao_luma[3] = (pf_hbd_sao_luma)ps_codec->s_func_selector.ihevc_hbd_sao_edge_offset_class3_fptr;

    ps_codec->apf_hbd_sao_chroma[0] = (pf_hbd_sao_chroma)ps_codec->s_func_selector.ihevc_hbd_sao_edge_offset_class0_chroma_fptr;
    ps_codec->apf_hbd_sao_chroma[1] = (pf_hbd_sao_chroma)ps_codec->s_func_selector.ihevc_hbd_sao_edge_offset_class1_chroma_fptr;
    ps_codec->apf_hbd_sao_chroma[2] = (pf_hbd_sao_chroma)ps_codec->s_func_selector.ihevc_hbd_sao_edge_offset_class2_chroma_fptr;
    ps_codec->apf_hbd_sao_chroma[3] = (pf_hbd_sao_chroma)ps_codec->s_func_selector.ihevc_hbd_sao_edge_offset_class3_chroma_fptr;

    ps_codec->apf_hbd_inter_pred[0] = NULL;
    ps_codec->apf_hbd_inter_pred[1] = (pf_hbd_inter_pred)ps_codec->s_func_selector.ihevc_hbd_inter_pred_luma_copy_fptr;
    ps_codec->apf_hbd_inter_pred[2] = (pf_hbd_inter_pred)ps_codec->s_func_selector.ihevc_hbd_inter_pred_luma_vert_fptr;
    ps_codec->apf_hbd_inter_pred[3] = (pf_hbd_inter_pred)ps_codec->s_func_selector.ihevc_hbd_inter_pred_luma_horz_fptr;
    ps_codec->apf_hbd_inter_pred[4] = (pf_hbd_inter_pred)ps_codec->s_func_selector.ihevc_hbd_inter_pred_luma_horz_w16out_fptr;
    ps_codec->apf_hbd_inter_pred[5] = (pf_hbd_inter_pred)ps_codec->s_func_selector.ihevc_hbd_inter_pred_luma_copy_w16out_fptr;
    ps_codec->apf_hbd_inter_pred[6] = (pf_hbd_inter_pred)ps_codec->s_func_selector.ihevc_hbd_inter_pred_luma_vert_w16out_fptr;
    ...
    ps_codec->apf_hbd_inter_pred[14] = (pf_hbd_inter_pred)ps_codec->s_func_selector.ihevc_hbd_inter_pred_chroma_horz_fptr;
    ps_codec->apf_hbd_inter_pred[15] = (pf_hbd_inter_pred)ps_codec->s_func_selector.ihevc_hbd_inter_pred_chroma_horz_w16out_fptr;
    ps_codec->apf_hbd_inter_pred[16] = (pf_hbd_inter_pred)ps_codec->s_func_selector.ihevc_hbd_inter_pred_chroma_copy_w16out_fptr;
    ps_codec->apf_hbd_inter_pred[17] = (pf_hbd_inter_pred)ps_codec->s_func_selector.ihevc_hbd_inter_pred_chroma_vert_w16out_fptr;
                                   ...
                                   ihevcd_cxa_create_op_t *ps_create_op)
{
    ...
    *pps_codec_obj = (iv_obj_t *)pv_buf;
    ...
    size = (4 * MAX_CTB_SIZE * MAX_CTB_SIZE + 8 * MAX_CTB_SIZE * MAX_CTB_SIZE) * PIXEL_SIZE_2BYTES;
    ...
    for(i = 0; i < MAX_PROCESS_THREADS; i++)
    {
        ...
        pu1_buf += 4 * MAX_CTB_SIZE * MAX_CTB_SIZE * sizeof(UWORD8) * PIXEL_SIZE_2BYTES ;

        ps_codec->as_process[i].s_sao_ctxt.pu1_tmp_buf_chroma = (UWORD8 *)pu1_buf;
        pu1_buf += 8 * MAX_CTB_SIZE * MAX_CTB_SIZE * sizeof(UWORD8) * PIXEL_SIZE_2BYTES;
    }
...
WORD32 ihevcd_allocate_dynamic_bufs(codec_t *ps_codec)
{
...

    {
        ...
        size  = ps_codec->i4_pixel_size_y * (MAX(ht, wd));

        /* To hold SAO left buffer for chroma */
        if(ps_sps->i1_chroma_format_idc != CHROMA_FMT_IDC_MONOCHROME)
        {
            size += ps_codec->i4_pixel_size_uv * (MAX(ht, wd)) * (chroma_pixel_strd / v_samp_factor);
        }

        /* To hold SAO top buffer for luma */
        size += ps_codec->i4_pixel_size_y * wd;

        /* To hold SAO top buffer for chroma */
        if(ps_sps->i1_chroma_format_idc != CHROMA_FMT_IDC_MONOCHROME)
        {
            size += ps_codec->i4_pixel_size_uv * wd * (chroma_pixel_strd / h_samp_factor);
        }

        /* To hold SAO top left luma pixel value for last output ctb in a row*/
        size += ps_codec->i4_pixel_size_y * max_ctb_rows;
        ...
        size += ps_codec->i4_pixel_size_y * max_ctb_cols;

        /* To hold SAO top right pixel chroma pixel value last output ctb in a row*/
        if(ps_sps->i1_chroma_format_idc != CHROMA_FMT_IDC_MONOCHROME)
        {
            size += ps_codec->i4_pixel_size_uv * max_ctb_cols * 2;
        }
        ...
        pu1_buf += MAX(ht, wd) * ps_codec->i4_pixel_size_y;
        ...
        pu1_buf += wd * ps_codec->i4_pixel_size_y;
        ...
        pu1_buf += (ht / MIN_CTB_SIZE) * ps_codec->i4_pixel_size_y;
        ...
        if(ps_sps->i1_chroma_format_idc != CHROMA_FMT_IDC_MONOCHROME)
        {
            ...
            pu1_buf += (ht / MIN_CTB_SIZE) * 2 * ps_codec->i4_pixel_size_uv;
        }
        ...
        pu1_buf += (wd / MIN_CTB_SIZE) * ps_codec->i4_pixel_size_y;
        ...
        if(ps_sps->i1_chroma_format_idc != CHROMA_FMT_IDC_MONOCHROME)
        {
            ...
            pu1_buf += (wd / MIN_CTB_SIZE) * 2 * ps_codec->i4_pixel_size_uv;
        }
    ...
    ps_codec->pu1_bitsbuf_dynamic = NULL;
    {
        ...
        {
            size = wd * ht * 3 * pixel_size;
        }
        else if(ps_sps->i1_chroma_format_idc == CHROMA_FMT_IDC_YUV422)
        {
            size = wd * ht * 2 * pixel_size;
        }
        else
        {
            size = wd * ht * pixel_size;
        }
                         ...
                         void *pv_api_op)
{
    ...
    {
        pixel_size_y  = sizeof(UWORD16);
        pixel_size_uv = pixel_size_y;
    ...
    if(ps_codec->e_chroma_fmt == IV_YUV_420P)
    {
        ...
        ps_ctl_op->u4_min_out_buf_size[1] = ((aligned_wd * aligned_ht) >> 2) * pixel_size_uv;
        ps_ctl_op->u4_min_out_buf_size[2] = ((aligned_wd * aligned_ht) >> 2) * pixel_size_uv;
    }
    else if(ps_codec->e_chroma_fmt == IV_YUV_444P)
    {
        ps_ctl_op->u4_min_out_buf_size[0] = (wd * ht) * pixel_size_y;
        ps_ctl_op->u4_min_out_buf_size[1] = (wd * ht) * pixel_size_uv;
        ps_ctl_op->u4_min_out_buf_size[2] = (wd * ht) * pixel_size_uv;
    }
    else if((ps_codec->e_chroma_fmt == IV_YUV_420SP_UV)
                    || (ps_codec->e_chroma_fmt == IV_YUV_420SP_VU))
    {
        ps_ctl_op->u4_min_out_buf_size[0] = (wd * ht) * pixel_size_y;
        ps_ctl_op->u4_min_out_buf_size[1] = ((aligned_wd * aligned_ht) >> 1) * pixel_size_uv;
    ...
    {
        ps_ctl_op->u4_min_out_buf_size[0] = (wd * ht) * pixel_size_y;
        ps_ctl_op->u4_min_out_buf_size[1] = ((aligned_wd * ht) >> 1) * pixel_size_uv;
        ps_ctl_op->u4_min_out_buf_size[2] = ((aligned_wd * ht) >> 1) * pixel_size_uv;
    }
                                   ...
                                   void *pv_api_op)
{
    ...
    ps_op->u4_buffer_wd[1] = ps_op->u4_buffer_wd[2] = ((ps_op->u4_buffer_wd[0] + 1) >> 1);
    ps_op->u4_buffer_ht[1] = ps_op->u4_buffer_ht[2] = ((ps_op->u4_buffer_ht[0] + 1) >> 1);
